...
const AQ_ACTION_PROPERTY apButtonLargeImage         =  101;   // HBITMAP. The handle of the large button image.
const AQ_ACTION_PROPERTY apButtonShowText           =  102;   // Boolean. Specifies whether the caption of the action will be shown on a toolbar
const AQ_ACTION_PROPERTY apButtonPropertyCount    	=  3;    // Helper constant. The number of properties specific to Button actions.
